...
# マージン設定（円）
# ==============================
# SKU（売場コード）ごとのマージン特例。なつきが「この弾は強気に集めたい」と決めた弾だけ入れる。
# ゲーム共通の MARGINS より優先する。キーは競合表のコード（例 "OP-13"）。
# 2026-08-13 なつき指示: OP-13 はかなり集めたいので ホムラ +500 / +5,000。
SKU_MARGIN_OVERRIDES = {
    "OP-13": {"box": 500, "carton": 5000},
}
